...
> [!NOTE] From https://developers.yubico.com/SSH/Securing_SSH_with_FIDO2.html

> [!CAUTION] Must use ssh that is linked to libfido2, e.g. /opt/homebrew/bin/ssh on macos
